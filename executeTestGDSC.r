...
load(paste(folder_dir,"Rdata/training_data.RData",sep=""))
...
# FOR KRL
write.csv(mutations_AML_GDSC, file="data/input/mutations_AML_GDSC_NAs.csv")
...
ggsave(paste(folder_dir,"Rimages/violin_mutations_GDSC.png",sep=""), treatment_plot_violin, width = 8, height = 7, dpi = 1000)
...
g2_gdsc
ggsave(paste(folder_dir,"Rimages/boxplot_mutations_GDSC.png",sep=""), g2_gdsc, width = 8, height = 7, dpi = 1000)
...
# 
# gg1_validation_gdsc
# ggsave(paste(folder_dir,"Rimages/intragroup_MOM_GDSC.png",sep=""), gg1_validation_gdsc, width = 10, height = 10, dpi = 1000)
# 
# # ODTMut
...
# 
# gg3_validation_gdsc
# ggsave(paste(folder_dir,"Rimages/intragroup_ODTMut_GDSC.png",sep=""), gg3_validation_gdsc, width = 10, height = 10, dpi = 1000)
# 
# # ODTSqrtMut
# Plot_aux<-Validation_GDSC[Validation_GDSC$Method=="ODTSqrtMut",]
# 
# ODTQR_plots<-NULL
# 
# for(j in 1:length(unique(Plot_aux$drug))){
...
#   geom_boxplot()+facet_wrap(~drugname)+theme_bw()+scale_fill_manual(values=c("#999999", "#E69F00"))+
#   stat_compare_means()+ylab("IC50*")+ggtitle("ODTSqrtMut")
# 
# gg4_validation_gdsc
# ggsave(paste(folder_dir,"Rimages/intragroup_ODTSqrtMut_GDSC.png",sep=""), gg4_validation_gdsc, width = 10, height = 10, dpi = 1000)